...
boxplot(m.max.kostelec3[["all"]][["l8"]], ylim = c(0.5, 1), main= "Landsat 8")
boxplot(m.max.kostelec3[["all"]][["all"]], ylim = c(0.5, 1), main= "Bioclim+Landsat 8")
...
m.v.vif.s <- m.v.vif[["all"]][["all"]][[as.character(1)]]
