...
px_size <- c(100, 200, 1000) # 100, 200, 1000, 2000, 5000, 10000
...
for (px_size_item in px_size) {
  for (species_u_item in species_u) {
    ...
    # write_csv(bind_cols(csvgee_1[1,], csvgee_2[1,]), paste0(export_path, "results_100_200_1000-100top.csv"), append = TRUE)
