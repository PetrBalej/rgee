...
# Define a geometry
# sitmap_2rad <- st_read(paste0(path.igaD, "sitmap_2rad/sitmap_2rad_4326_czechia_N.shp"))
sitmap_2rad <- st_read(paste0(path.igaD, "sitmap_2rad/sitmap_2rad_4326_czechia_S.shp"))
output_df <- list()
...
saveRDS(output_df, file = paste0(path.igaD, "test-kfme16-S_czechia_wc_l8_2018-2021_4-6.rds"))
